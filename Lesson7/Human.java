...
public class Human {
    ...
    public void describePet() {
        if (family.getPet().getTrickLevel() > 50) {
            System.out.printf("I have a " + family.getPet().getSpecies() + " who is " + family.getPet().getAge() + " years old, and he is very sly.");
        } else {
            System.out.printf("I have a " + family.getPet().getSpecies() + " who is " + family.getPet().getAge() + " years old, and he is almost not sly.");
        }
    }
